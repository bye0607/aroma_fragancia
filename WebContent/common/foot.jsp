...
<div class="container">
	...
	<hr>
		<h4>
			<a style="font-size: 15px;" href="#">회사소개&nbsp;&nbsp;|</a>
			<a style="font-size: 15px;" href="#">제품&nbsp;&nbsp;|</a>
			<a style="font-size: 15px;" href="#">고객센터&nbsp;&nbsp;|</a>
			<a style="font-size: 15px;" href="#">개인정보처리방침</a>
			<p></p>
			<p style="font-size: 15px;">FOLLOW US ON</p>
			<p>
	      	...
	      	<p></p>
			<p style="font-size: 15px;">&copy;Since 2023 AROMA, FRAGANCIA. All Rights Reserved.</p>
			<br>
		</h4>
	</footer>
</div>
